...
- (void)startDrifting:(UIImageView *)imgView
{
    [self.motionManager startAccelerometerUpdatesToQueue:[[[NSOperationQueue alloc] init] autorelease] withHandler:^(CMAccelerometerData *accelerometerData, NSError *error) {
        dispatch_sync(dispatch_get_main_queue(), ^(void) {
            ...
            accelerationX.text = [NSString stringWithFormat:@"accelerationX : %d", accelerometerData.acceleration.x];
            accelerationY.text = [NSString stringWithFormat:@"accelerationY : %d", accelerometerData.acceleration.y];
            accelerationZ.text = [NSString stringWithFormat:@"accelerationZ : %d", accelerometerData.acceleration.z];
        });
